...
for label, (col, lower_is_better) in metrics.items():
    ...
    result[f"{label} %"] = pct
    result[f"{label} Score"] = improvement
...
df_analysis["Efficiency1"] = df_analysis["HR1"] / df_analysis["Pace1"]
df_analysis["Efficiency2"] = df_analysis["HR2"] / df_analysis["Pace2"]
